...
public class End
{
    ...
    public String toString() {
        return "End(location=" + this.getLocation() + ", time=" + this.getTime() + ", instructions=" + this.getInstructions() + ", contact=" + this.getContact() + ", person=" + this.getPerson() + ")";
    }
}
