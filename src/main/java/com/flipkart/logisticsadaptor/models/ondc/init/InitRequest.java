...
public class InitRequest
{
    ...
    public void setMessage(final InitMessage message) {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof InitRequest)) {
            return false;
        }
        final InitRequest other = (InitRequest)o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof InitRequest;
    }
    ...
    public String toString() {
        return "InitRequest(context=" + this.getContext() + ", message=" + this.getMessage() + ")";
    }
}
