...
public class TrackRequest
{
    ...
    public void setMessage(final TrackMessage message) {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof TrackRequest)) {
            return false;
        }
        final TrackRequest other = (TrackRequest)o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof TrackRequest;
    }
    ...
    public String toString() {
        return "TrackRequest(context=" + this.getContext() + ", message=" + this.getMessage() + ")";
    }
}
