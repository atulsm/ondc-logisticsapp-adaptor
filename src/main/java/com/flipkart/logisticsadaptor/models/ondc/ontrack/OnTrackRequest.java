...
public class OnTrackRequest
{
    ...
    public OnTrackMessage getMessage() {
        return this.message;
    }
    ...
    public void setMessage(final OnTrackMessage message) {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof OnTrackRequest)) {
            return false;
        }
        final OnTrackRequest other = (OnTrackRequest)o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof OnTrackRequest;
    }
    ...
    public String toString() {
        return "OnTrackRequest(context=" + this.getContext() + ", message=" + this.getMessage() + ")";
    }
}
