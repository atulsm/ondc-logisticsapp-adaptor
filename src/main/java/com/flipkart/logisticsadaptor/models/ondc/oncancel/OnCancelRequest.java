...
public class OnCancelRequest
{
    ...
    public OnCancelMessage getMessage() {
        return this.message;
    }
    ...
    public void setMessage(final OnCancelMessage message) {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof OnCancelRequest)) {
            return false;
        }
        final OnCancelRequest other = (OnCancelRequest)o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof OnCancelRequest;
    }
    ...
    public String toString() {
        return "OnCancelRequest(context=" + this.getContext() + ", message=" + this.getMessage() + ")";
    }
}
